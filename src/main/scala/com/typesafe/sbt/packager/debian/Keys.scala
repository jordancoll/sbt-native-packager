...
trait DebianKeys {
  ...
  val debianPackageConflicts = SettingKey[Seq[String]]("debian-package-conflicts", "Packages that conflict with this package.")
  val debianPackageSuggests = SettingKey[Seq[String]]("debian-package-suggests")
  val debianPackageEnhances = SettingKey[Seq[String]]("debian-package-enhances")
  val debianPackagePreDepends = SettingKey[Seq[String]]("debian-package-predepends")
  val debianPackageBreaks = SettingKey[Seq[String]]("debian-packagebreaks")
  val debianPackageProvides = SettingKey[Seq[String]]("debian-package-provides")
  val debianPackageReplaces = SettingKey[Seq[String]]("debian-package-replaces")
